                        ...
                        <li>
                            ...
                            <ul class="menu">
                                <li><!-- start message -->
                                    <a href="#">
                                        <div class="pull-left">
                                            <img src="/public/components/adminlte-2.3.0/dist/img/user2-160x160.jpg"
                                                 class="img-circle"
                                                 alt="User Image">
                                        </div>
                                        <h4>
                                ...
                                <li>
                                    <a href="#">
                                        <div class="pull-left">
                                            <img src="/public/components/adminlte-2.3.0/dist/img/user3-128x128.jpg"
                                                 class="img-circle"
                                                 alt="User Image">
                                        </div>
                                        <h4>
                                ...
                                <li>
                                    <a href="#">
                                        <div class="pull-left">
                                            <img src="/public/components/adminlte-2.3.0/dist/img/user4-128x128.jpg"
                                                 class="img-circle"
                                                 alt="User Image">
                                        </div>
                                        <h4>
